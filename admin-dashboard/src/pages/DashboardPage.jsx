...
export default function DashboardPage() {
  ...
  useEffect(() => {
    getDashboard().then(setData).catch(() => navigate('/login'));
  }, [navigate]);
  ...
  return (
    <main className="page">
      <section className="hero-card">
        ...
        <button className="btn" onClick={() => { logoutAdmin(); navigate('/login'); }}>Logout</button>
      </section>
        ...
        <>
          ...
          <section className="card">
            <div className="row-between">
              <h3>Officers</h3>
              <Link className="btn secondary" to="/officers">Manage Officers</Link>
            </div>
            <div className="list-stack">
          ...
          <section className="card">
            <div className="row-between">
              <h3>Complaints</h3>
              <Link className="btn secondary" to="/complaints">View All</Link>
            </div>
          </section>
        </>
      )}
