...
export default function OfficersPage() {
  ...
  useEffect(() => {
    getOfficers().then((data) => setOfficers(data.officers || [])).catch(() => navigate('/admin/login'));
  }, [navigate]);
    ...
    <main className="page">
      <section className="card">
        <div className="row-between">
          ...
          <Link className="btn secondary" to="/admin/dashboard">Back</Link>
        </div>
          ...
          {officers.map((officer) => (
            <div key={officer._id} className="row-between pill-row">
              ...
              <div className="officer-management-actions">
                ...
                <Link className="btn secondary manage-button" to={`/admin/officers/${officer._id}/manage`}>
                  Manage
